...
//   // 1) On mount: pick up any existing cookie
//   useEffect(() => {
//     const existing = readCookie('fitting_cart_id')
//     if (existing) {
//       setFitCartId(existing)
//     }
//   }, [])

//   // 2) Whenever we learn (or re-learn) the cart ID, fetch its requests
//   useEffect(() => {
//     if (!fitCartId) return
...
//       .then((r) => r.json())
//       .then((json) => {
//         if (!json.success) throw new Error(json.error || 'Failed to load fitting cart')
//         const cart = json.fittingCart || json.cart  // adapt if your API keys differ
//         if (!cart.requests) throw new Error('Malformed fitting cart response')
//         setRequests(
//           cart.requests.map((r: any) => ({
...
//   // Helper to create (and cookie-persist) a new fitting-cart
//   const ensureFitCart = async (): Promise<string> => {
//     if (fitCartId) return fitCartId
...
//       value={{ fitCartId, requests, addRequest, transferToCart }}
//     >
//       {children}
//     </FittingCartContext.Provider>
//   )
...
// context/fitting-cart-context.tsx
// context/fitting-cart-context.tsx
// context/fitting-cart-context.tsx
// context/fitting-cart-context.tsx
// context/fitting-cart-context.tsx
