            ...
            <div className="md:w-1/2 bg-white p-8 md:p-12 relative overflow-hidden">
              <div className="relative h-full">
                ...
                <div className={`transition-all duration-500 ease-in-out ${isSignIn ? "translate-x-0 opacity-100" : "-translate-x-full opacity-0 absolute inset-0 pointer-events-none"}`}>
                  ...
                  <form onSubmit={handleSignIn} className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <input id="remember-me" type="checkbox" checked={rememberMe} onChange={e => setRememberMe(e.target.checked)} className="h-4 w-4 text-amber-800 focus:ring-amber-800 border-stone-300 rounded cursor-pointer" />
                    ...
                    <div>
                      <button type="submit" disabled={loading} className="cursor-pointer w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-amber-800 hover:bg-amber-700 disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-800">
                  ...
                  <div className="mt-6">
                    <button onClick={handleGoogleSignIn} className="cursor-pointer w-full flex justify-center items-center py-2 px-4 border border-stone-300 rounded-md shadow-sm text-sm font-medium text-stone-700 bg-white hover:bg-stone-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-800">
                      {/* Google icon SVG */}
                  ...
                  <div className="mt-6 text-center"><p className="text-sm text-stone-600">Don’t have an account? <button type="button" onClick={toggleForm} className="cursor-pointer font-medium text-amber-800 hover:text-amber-700 inline-flex items-center">Sign up <ArrowRight size={16} className="ml-1" /></button></p></div>
                </div>
                ...
                >
                  ...
                  <form onSubmit={handleSignUp} className="space-y-6">
                    ...
                    <div className="flex items-center">
                      <input id="terms" type="checkbox" required checked={acceptTerms} onChange={e => setAcceptTerms(e.target.checked)} className="cursor-pointer h-4 w-4 text-amber-800 focus:ring-amber-800 border-stone-300 rounded" />
                  ...
                  <div className="mt-6 text-center"><p className="text-sm text-stone-600">Already have an account? <button type="button" onClick={toggleForm} className=" cursor-pointer font-medium text-amber-800 hover:text-amber-700 inline-flex items-center">Sign in <ArrowRight size={16} className="ml-1" /></button></p></div>
                </div>
              </div>
            </div>
          </div>
